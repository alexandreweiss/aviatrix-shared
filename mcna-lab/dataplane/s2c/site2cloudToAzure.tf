...
resource "aviatrix_transit_external_device_conn" "azure_0" {
  ...
  remote_gateway_ip        = "4.175.3.14"
  local_tunnel_cidr        = "169.254.21.2/30,169.254.21.6/30"
  remote_tunnel_cidr       = "169.254.21.1/30,169.254.21.5/30"
