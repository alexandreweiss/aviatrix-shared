...
resource "azurerm_resource_group" "app1_vms_rg" {
  ...
  name     = "app1-structure-only-vms-rg"
}
...
resource "aviatrix_web_group" "allowed_domains" {
  name = "${var.application_1}-allowed-domains"
  selector {
    match_expressions {
...
resource "aviatrix_web_group" "allowed_urls" {
  name = "${var.application_1}-allowed-urls"
  selector {
    match_expressions {
      urlfilter = "https://www.youtube.com/channel/UC36qOlKmPitaVA1Hq8j3daQ"
    }
  }
}
